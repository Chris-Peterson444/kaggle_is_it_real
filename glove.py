...
# loaded_emb = load_embeddings('ud_embeddings/ud_basic.vec')
loaded_emb = torchtext.vocab.GloVe(name = '6B', dim = 300)
...
# print_tuples(analogy(loaded_emb, 'man', 'actor', 'woman'))
